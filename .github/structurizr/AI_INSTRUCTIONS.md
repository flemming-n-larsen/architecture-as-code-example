...
5. Outputs SVG files to `/architecture/c4-views/images/`
...
- **Output directory**: `architecture/c4-views/images/` 📁 VERSION CONTROLLED

See `.tools/README.md` for detailed tool documentation and GitHub Actions integration examples.
