...
- [Keep Your AI and Architecture-Design in Sync](../2.%20Keep%20Your%20AI%20and%20Architecture-Design%20in%20Sync/README.md)
- [Architecture as Code in Practice](../3.%20Architecture%20as%20Code%20in%20Practice/README.md)
- [Think in Specs — The Modern Developer's Mindset](../4.%20Think%20in%20Specs%20-%20The%20Modern%20Developers%20Mindset/README.md)
...
In [article 4](../4.%20Think%20in%20Specs%20-%20The%20Modern%20Developers%20Mindset/README.md), I argued that the real work in the agentic AI age is still architecture + design + implementation — just with AI increasingly doing the code generation.
...
```mermaid
graph TD
    P["📋 Change proposal<br><i>Intent, rules, scenarios</i>"]
    AC["🏷️ Scenario ID<br><i>Example: LP-004</i>"]
    TT["🧪 Test type<br><i>Example: Unit, Integration</i>"]
    TC["⚙️ Test code<br><i>@Tag(&quot;LP-004&quot;)<br>// AC: LP-004</i>"]
    CI["✅ CI enforcement<br><i>Every non-manual AC covered</i>"]
...
- [`openspec/changes/loyalty-points/proposal.md`](../../openspec/changes/loyalty-points/proposal.md)
- [`openspec/changes/loyalty-points/specs/customer/spec.md`](../../openspec/changes/loyalty-points/specs/customer/spec.md)
...
```mermaid
graph BT
    L1["L1<br><b>Unit</b><br><i>Fastest<br>Pure logic</i>"]
    L2["L2<br><b>Slice</b><br><i>Spring wiring<br>Controllers & repos</i>"]
    L3["L3<br><b>Integration</b><br><i>Real infra<br>Single-service boundary</i>"]
    L4["L4<br><b>E2E</b><br><i>Full pipeline<br>Executable workflow</i>"]
    L5["L5<br><b>Performance</b><br><i>Load & throughput</i>"]
...
```mermaid
graph LR
    Proposal["📋 Proposal<br><i>Intent, rules, acceptance criteria</i>"]
    Tests["🧪 Test package<br><i>Proof bundle for the change<br>Mapped to AC IDs</i>"]
    Code["⚙️ Implementation<br><i>Human- or AI-generated code</i>"]

    Proposal -->|"defines"| Tests
    Proposal -->|"guides"| Code
    Tests -->|"proves"| Code
```
...
```mermaid
flowchart LR
    T1["Task N"] --> I["Implement"]
    I --> P["Run task proof<br><i>Unit / Integration / E2E as needed</i>"]
    P --> R["Review"]
    R --> C["Commit"]
    C --> N["Task N+1"]
```
...
```mermaid
flowchart LR
    Push["git push"] --> Fast["Run L1-L3<br><i>Unit, Slice, Integration</i>"]
    PR["Pull request"] --> Full["Run L1-L4<br><i>Add E2E</i>"]
    Demand["On demand"] --> Perf["Run L5<br><i>Performance</i>"]
```
...
```mermaid
graph TD
    Human["👤 Human judgment<br><i>Clarifies intent</i>"]
    Spec["📋 Proposal + spec<br><i>Defines ACs and test types</i>"]
    Tests["🧪 Proof package<br><i>Positive + negative proof</i>"]
    Code["⚙️ Implementation<br><i>Generated or written</i>"]
    Confidence["✅ Confidence<br><i>Approved intent + passing proof</i>"]
...
← **[Previous: Think in Specs — The Modern Developer's Mindset](../4.%20Think%20in%20Specs%20-%20The%20Modern%20Developers%20Mindset/README.md)**  

→ **[Up next: Expert Knowledge as Code: Portable AI Lenses](../ideas.md#expert-knowledge-as-code-portable-ai-lenses)**
